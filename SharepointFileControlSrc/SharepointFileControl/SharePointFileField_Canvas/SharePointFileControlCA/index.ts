...
export class SharePointFileControlCA implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    public init(
        ...
        this.props = {
            context: context,
            fileName: context.parameters.fullPath.raw || "",
    ...
    public getOutputs(): IOutputs {
        return {
            fullPath: this.props.fileName,
            outputFullPath: this.props.fileName,
